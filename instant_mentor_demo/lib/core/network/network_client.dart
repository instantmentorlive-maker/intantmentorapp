...
class NetworkClient {
    ...
    _dio.interceptors.add(
      InterceptorsWrapper(
        ...
        onResponse: (response, handler) {
          Logger.debug('HTTP Response: ${response.statusCode} ${response.requestOptions.path}');
  ...
  static Dio createClient({
    ...
    dio.options = BaseOptions(
      ...
      connectTimeout: Duration(milliseconds: connectTimeout ?? config.connectTimeout),
      receiveTimeout: Duration(milliseconds: receiveTimeout ?? config.receiveTimeout),
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
        ...?headers,
