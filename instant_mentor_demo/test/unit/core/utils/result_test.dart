...
void main() {
  ...
  group('ResultUtils', () {
    ...
    test('tryCall should return Failure for throwing operation', () {
      // Act
      final result = ResultUtils.tryCall<String>(() => throw Exception('test error'));
    ...
    test('tryCallAsync should return Success for successful async operation', () async {
      // Act
      final result = await ResultUtils.tryCallAsync(() async => 'async success');
    ...
    test('tryCallAsync should return Failure for throwing async operation', () async {
      // Act
      final result = await ResultUtils.tryCallAsync<String>(() async => throw Exception('async error'));
